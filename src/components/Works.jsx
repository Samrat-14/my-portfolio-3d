                ...
                <div className="relative w-full h-[230px]">
                    ...
                    <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
                        <div
                            ...
                            className="shadow-sm shadow-white black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
                        >
                            <img
                                src={github}
                                alt="github"
                    ...
                    <div className="absolute inset-0 flex justify-end mr-14 mt-3 card-img_hover">
                        <div
